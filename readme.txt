...
- You did not create a desktop shortcut or
- PowerShell is restricted from running script.
...
If neither of these tools is used, nor an alternative method is applied, PowerShell may prompt you with an Execution Policy warning and ask whether to continue.
